...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li tabIndex={0}>
        <details>
          <summary className={`text-${isDarkMode ? 'dark' : 'black'}`}>Our Product</summary>
          <ul className={`p-2 ${isDarkMode ? 'dark' : ''}`}>
            ...
            <li>
              <a className={`text-${isDarkMode ? 'dark' : 'dark'}`}>Fresh Vegetables</a>
            </li>
            <li>
              <a className={`text-${isDarkMode ? 'dark' : 'dark'}`}>Fresh Fruit</a>
            </li>
            <li>
              <a className={`text-${isDarkMode ? 'dark' : 'dark'}`}>Kitchen Spices & Puries</a>
            </li>
            <li>
              <a className={`text-${isDarkMode ? 'dark' : 'dark'}`}>Dehydrated Flakes & Powder</a>
            </li>
            <li>
              <a className={`text-${isDarkMode ? 'dark' : 'dark'}`}>Eco Packaging</a>
            </li>
          </ul>
        </details>
      </li>
  ...
  return (
    <header
      className={`max-w-screen-2xl container mx-auto fixed top-0 left-0 right-1 transition-all duration-300 ease-in-out ${isDarkMode ? "dark" : ""}`}
    >
      <div
        className={`navbar -ml-40 w-[110rem] xl:px-64 ${
          isSticky
      ...
      >
        <div className="navbar-start">
          <div className="dropdown justify-between">
            ...
            <ul
              tabIndex={0}
              className={`menu menu-sm dropdown-content mt-3 z-[1] shadow bg-base-100 rounded-box w-64 space-y-3 ${isDarkMode ? 'dark' : ''}`}
